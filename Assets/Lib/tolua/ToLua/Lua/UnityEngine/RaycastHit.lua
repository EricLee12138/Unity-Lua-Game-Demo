...
RaycastHit._overrideNew = RaycastHit.New
RaycastHit._retainNew = function(old_v, new_v)
	return new_v
end
RaycastHit.New = function(collider, distance, normal, point, rigidbody, transform)
	return RaycastHit._overrideNew(collider, distance, normal, point, rigidbody, transform)
end
----------------------------------------
...
function RaycastHit:Init(collider, distance, normal, point, rigidbody, transform)
	...
	self.normal 	= RaycastHit._retainNew(self.normal, normal)
	self.point 		= RaycastHit._retainNew(self.point, point)
...
function RaycastHit:Destroy()				
	...
	self.normal 	= RaycastHit._retainNew(self.normal, nil)
	self.point 		= RaycastHit._retainNew(self.point, nil)	
end
