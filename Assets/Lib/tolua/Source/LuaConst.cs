...
{
    public static string luaDir = Application.dataPath + "/Lib/tolua/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/Lib/tolua/ToLua/Lua";        //tolua lua文件目录
